...
function ProductInfo({ furniture }) {
  ...
  const [productAdditionalInfo, setProductAdditionalInfo] = useState(false)
      ...
      <div className="container flex gap-6">
        <div className="w-full">
            ...
            <div className="flex space-x-2">
              {product.images_product.map((url, index) => (
                ...
                >
                  <img
                    src={url}
                    className={`w-[80px] rounded-md mr-2 object-cover cursor-pointer border ${activeIndex === index ? "border-maincolor" : ""
                      }`}
                    //   draggable="false"
                    onClick={() => {
          ...
          <div className="border w-full flex gap-1 rounded-md p-1">
            <button className="btn btn-sm flex-1" onClick={()=>{setProductAdditionalInfo(false)}}>Характеристики</button>
            <button className="btn btn-sm flex-1" onClick={()=>{setProductAdditionalInfo(true)}}>Описание</button>
          </div>

          { productAdditionalInfo && <div className="my-4">
            <h2 className="text-[20px] font-medium mb-2">{product.description_title}</h2>
            <p className="text-justify">{product.description}</p>
            <img src={product.image_des} className="h-[400px] w-full object-cover" />
          </div>}
          ...
          { !productAdditionalInfo && <div className="my-4">
              <table className="table table-zebra">
                ...
                <thead>
                  <tr>
                    <th className="text-[18px]">Характеристики</th>
                    {/* <th>Job</th> */}
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td>Наполнитель</td>
                    <td>ППУ, Холкон, Независимый пружинный блок</td>
                  </tr>
                  <tr>
                    <td>ППУ, Холкон, Независимый пружинный блок</td>
                    <td>200</td>
                  ...
                  <tr>
                    <td>Высота посадочного места</td>
                    <td>50</td>
                  </tr>
                  <tr>
                    <td>Гарантия</td>
                  ...
                  <tr>
                    <td>Примечание</td>
                    <td>*гарантия на металлокаркас</td>
                  </tr>
                </tbody>
              </table>            
          </div>}
            ...
            <div className="border rounded-md p-2 w-full grid grid-cols-3 gap-1 mt-2 font-semibold">
              <div className="flex gap-1 items-center justify-center">
                <svg width="23" height="10" viewBox="0 0 23 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <line x1="2" y1="4.99992" x2="21.3846" y2="4.99993" stroke="#9399A0" strokeWidth="1.61538"></line>
                  <line x1="22.1923" y1="9.03833" x2="22.1923" y2="0.961408" stroke="#9399A0" strokeWidth="1.61538"></line>
                  <line x1="1.19231" y1="9.03833" x2="1.19231" y2="0.961408" stroke="#9399A0" strokeWidth="1.61538"></line>
                </svg>
              ...
              <div className="flex gap-1 items-center justify-center">
                <svg width="15" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.3074 15.5383L3.23047 0.99987" stroke="#B6BDC5" strokeWidth="1.61538"></path>
                  <line y1="0.999925" x2="8.07692" y2="0.999925" stroke="#B6BDC5" strokeWidth="1.61538"></line>
                  <line x1="6.46191" y1="15.5385" x2="14.5388" y2="15.5385" stroke="#B6BDC5" strokeWidth="1.61538"></line>
                </svg>
              ...
              <div className="flex gap-1 items-center justify-center">
                <svg width="9" height="23" viewBox="0 0 9 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <line x1="4.03801" y1="21" x2="4.03801" y2="1.61539" stroke="#B6BDC5" strokeWidth="1.61538"></line>
                  <line x1="8.07715" y1="0.807692" x2="0.00022615" y2="0.807694" stroke="#B6BDC5" strokeWidth="1.61538"></line>
                  <line x1="8.07715" y1="21.8077" x2="0.00022615" y2="21.8077" stroke="#B6BDC5" strokeWidth="1.61538"></line>
                </svg>
